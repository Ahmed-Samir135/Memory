...
namespace Assign
{
    ...
    public partial class Form1 : Form
    {
        ...
        public static List<int> holes_start = new List<int>();
        public static List<int> holes_size = new List<int>();
        public static List<int> segment_number = new List<int>();
        public static List<List<int>> segment_name = new List<List<int>>();
        public static List<List<int>> segment_size = new List<List<int>>();
        public static int holes_num;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox1.Text == "") errorProvider2.SetError(comboBox1, "please select the Algorithm First");
